...
export const LampContainer = ({
    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 -translate-y-60">
                <motion.div
            ...
            <div className="relative z-50 flex -translate-y-[36rem] flex-col items-center px-5">
                {children}
            </div>
        </div>
    );
